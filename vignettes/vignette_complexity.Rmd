...
`complexity(4,1,2,2,3,3,4)` generates the following output: 
...
Thus, taking the model complexity into account, $H_i\text{: }(\beta_1 < \beta_2)$ \& $(\beta_2, \beta_3 > \beta_4)$ \& $(\beta_4, \beta_5 < \beta_6)$ fits better than $H_u\text{: }\mu_1, \mu_2, \mu_3$: the informative hypothesis receives more than three times the support. 
